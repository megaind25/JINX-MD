...
const date = moment().format('DD/MM/YYYY');
  ...
  *CASEYRHODES MD IS RUNNING WITH [${cm.length}0] COMMANDS*

  *mσrє cσmmαndѕ wíll вє αddєd ѕσσn*
...
`;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Caseyrhodes*, déveloper CASEYRHODES Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
