...
zokou({ nomCom: 'channel',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`https://whatsapp.com/channel/0029VakUEfb4o7qVdkwPk83E`) 
...
zokou({ nomCom: 'channel1',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`tap here to join my second channel https://whatsapp.com/channel/0029VakUEfb4o7qVdkwPk83E`) 
...
zokou({ nomCom: 'aloo',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_𝐂𝐀𝐒𝐄𝐘𝐑𝐇𝐎𝐃𝐄𝐒 𝐗𝐌𝐃 is running...... Love it_*`) 
...
zokou({ nomCom: 'group1',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`top a link to join boniphace group  https://whatsapp.com/channel/0029VakUEfb4o7qVdkwPk83E`) 
